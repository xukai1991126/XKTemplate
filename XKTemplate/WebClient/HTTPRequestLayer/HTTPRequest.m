...
/*
 配置好NetworkHelper各项请求参数,封装成一个公共方法,给以上方法调用,
 相比在项目中单个分散的使用NetworkHelper/其他网络框架请求,可大大降低耦合度,方便维护
...
+ (NSURLSessionTask *)requestWithURL:(NSString *)URL parameters:(NSDictionary *)parameter success:(RequestSuccess)success failure:(RequestFailure)failure
{
    ...
    // 设置请求头
    [NetworkHelper setValue:@"9" forHTTPHeaderField:@"fromType"];
    
    // 发起请求
    return [NetworkHelper POST:URL parameters:parameter success:^(id responseObject) {
